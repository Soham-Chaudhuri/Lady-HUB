        ...
        <div id='doc-results'>
            <div class='product-card' style="width: 40%;background-color:aqua">
                ...
                <div class='product-content'>
                    ...
                    <a href="./video_call/index.php"><button class="doc-button" style="padding: 0.6rem;margin:2rem 0 2rem 0;border-radius:5rem;background-color:#ff3256;cursor:pointer;border:5px solid #0dd;color:aliceblue;font-size:1rem;font-weight:600">Connect</Button></a>
                </div></a>
            </div>
        </div>
        <div id='doc-results'>
