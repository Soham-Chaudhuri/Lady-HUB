...
<body>
  ...
  <div class="container">
    <form method="post">
      ...
      <br>
      <input type="submit" class="inp" name="submit" action="submit" style="background-color:#ff3256; width:50%; margin-left:10rem;padding:0.6rem; font-size:1rem;font-weight:600;cursor:pointer">
    </form>
  </div>
